...
function createTagCount(allBlogs: any) {
  ...
  //         tagCount[fallbackLng][formattedTag] =
  //           (tagCount[fallbackLng][formattedTag] || 0) + 1;
  //       } else if (file.language === secondLng) {
  //         tagCount[secondLng][formattedTag] =
  //           (tagCount[secondLng][formattedTag] || 0) + 1;
  //       }
  //     });
  //   }
  // });
...
export default makeSource({
  contentDirPath: "./src/data", // entry point for parsing content
